package com.TUBEDELIVERIES.Payment;
...
public class PayFortPayment {
   ...
   private String randomNoString="";
    ...
    //Statics
    private final static String MERCHANT_IDENTIFIER = "XBBOoiYb";//"Cyc0HZ9xV6j";//;
    private final static String ACCESS_CODE = "aOqpXmHDKz15F6SzznWd";//"zx0IPmPy5jp1vAz8Kpg7";//;
    private final static String SHA_TYPE = "SHA-256";
    private final static String SHA_REQUEST_PHRASE = "cjyey3494";
    public final static String SHA_RESPONSE_PHRASE = "cjyey3494";
    ...
    public PayFortPayment(Activity context, FortCallBackManager fortCallback, IPaymentRequestCallBack iPaymentRequestCallBack, String methodName) {
    ...
    private void requestPurchase() {
        try {
            FortSdk.getInstance().registerCallback(context, getPurchaseFortRequest(methodName), FortSdk.ENVIRONMENT.TEST, RESPONSE_PURCHASE,
...
//            parameters.put("merchant_reference", "76442124546");
            ...
            parameters.put("payment_option", paymentMode);
            parameters.put("eci", "ECOMMERCE");
            parameters.put("order_description", "App");
//            parameters.put("customer_ip", "192.178.1.10");
            parameters.put("customer_name", "swati");
...
//            fortRequest.setRequestMap(parameters);
    ...
    public String getTokenParams() {
        ...
        try {
            ...
            String concatenatedString = SHA_REQUEST_PHRASE +
                   ...
                   //KEY_DEVICE_ID + "=" + "00000000-6796-318d-0000-000000000000" +
                    KEY_DEVICE_ID + "=" + device_id +
                    KEY_LANGUAGE + "=" + LANGUAGE_TYPE +
                    KEY_MERCHANT_IDENTIFIER + "=" + MERCHANT_IDENTIFIER +//Order Id
                    KEY_SERVICE_COMMAND + "=" + SDK_TOKEN + //First time command SDK_TOKEN next time value of SDK TOKEN
                    SHA_REQUEST_PHRASE;
           ...
           // jsonObject.put(KEY_DEVICE_ID, "00000000-6796-318d-0000-000000000000" );
    ...
    public String generateID() {
        ...
        randomNoString=String.valueOf(digits);
